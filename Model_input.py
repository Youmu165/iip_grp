...
def load_vit_model():
    ...
    state_dict = torch.load("fine_tuned_resnet50-4.pth", map_location=device,weights_only=False)
...
# segmented_folder = "/kaggle/working/output"
# ground_truth_folder = "/kaggle/input/flowerdata/trimaps-2"
segmented_folder = "segmentation_submission/segmented"
ground_truth_folder = "segmentation_submission/ground_truth"
results = []
